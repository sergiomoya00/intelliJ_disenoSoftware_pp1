...
public class Persona {
    ...
    public Persona(String primerApellido, String segundoApellido, String nombre, int cedula, Date fechaNacimiento, int telefono, String correoElectronico) {
    ...
    public void setFechaNacimiento(Date pFechaNacimiento){pFechaNacimiento = fechaNacimiento;}
    public static Date getFechaNacimiento(){return fechaNacimiento;}
